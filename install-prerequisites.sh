...
PLUGIN_NAME="pims-plugin-format-example"

"""
Write the prerequisites to install

It can be packages that are needed before the installation of the format plugin
itself.
"""
